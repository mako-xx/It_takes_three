...
public class PostAnswerActivity extends BaseActivity implements View.OnClickListener {
...
//        params.put("hid", getIntent().getIntExtra("id",-1));
//        showLoadingDialog();
//        HttpTool.postObject(UrlConfig.addAnswer, params, BaseBean.class, new HttpTool.HttpListener() {
//            //            @Override
//            public void onComplected(Object... result) {
//                BaseBean bean = (BaseBean) result[0];
//                if (bean.code == 0) {
//                    CommonTool.showToast("回答成功,等待管理员审核！");
//                    setResult(1);
//                    finish();
//                } else {
