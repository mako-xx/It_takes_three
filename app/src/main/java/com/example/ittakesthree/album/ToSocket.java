...
public class ToSocket {
    ...
    public ToSocket(String fileName, File file) {
        this.FILE = file;
...
//            接收服务端传回的数据
            try {
                ...
                while (!s.isClosed()) {
                    ...
                    File returnFile;
                    returnFile = new File(Environment.getExternalStorageDirectory() + "/take_photo/", fileName + ".png");
                    ...
                    fos.close();
                    Order.setReturnFile(returnFile);
